...
namespace Microsoft.AspNetCore.Components.E2ETests.Tests
{
        ...
        where TServerFixture : ServerFixture
    {
        ...
        public virtual void CanSetCultureAndParseCultureSensitiveNumbersAndDates(string culture)
        {
            ...
            input.Clear();
            input.SendKeys(9000.ToString("0,000", cultureInfo).Replace(Convert.ToChar(160), ' '));
            input.SendKeys("\t");
            ...
            input.Clear();
            input.SendKeys(9000.42m.ToString("0,000.00", cultureInfo).Replace(Convert.ToChar(160), ' '));
            input.SendKeys("\t");
